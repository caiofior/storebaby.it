...
class ShopShark_Blog_Block_Manage_Comment_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection->getSelect()->joinLeft(array('ShopShark_Blog_main' => $collection->getTable('blog/blog')), 'main_table.post_id=ShopShark_Blog_main.post_id', array('ShopShark_Blog_main.title'));
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('ShopShark_Blog_main.post_id', array(
