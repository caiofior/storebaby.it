...
class Mage_Catalog_Block_Navigation extends Mage_Core_Block_Template
{
    ...
    protected function _renderCategoryMenuItemHtml($category, $level = 0, $isLast = false, $isFirst = false,
        $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false, $showThumbnails = false, $isMobile = false)
    {
		...
		if(!empty($categoryMmenuStyle)) $_config['mmenu_style'] = $categoryMmenuStyle;
		...
		if(!$isMobile && $showThumbnails && ($categoryThumbnail = $ca->getThumbnail())) $_isThumbnail = true;
        ...
        foreach ($activeChildren as $child) {
            $htmlChildren .= $this->_renderCategoryMenuItemHtml(
                ...
                $childrenWrapClass,
                $noEventAttributes,
				(($level == 0) && ($_config['menutype'] == 1) && ($_config['mmenu_style'] == 2)),
				$isMobile
            );
            $j++;
            $columns++;
     ...
     * @return string
     */
    public function renderCategoriesMenuHtml($level = 0, $outermostItemClass = '', $childrenWrapClass = '', $isMobile = false)
    {
